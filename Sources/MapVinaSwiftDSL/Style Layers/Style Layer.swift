...
/// A description of layer in a MapVina style.
///
...
public protocol StyleLayerDefinition {
    ...
    /// property has not been explicitly set is an [implementation detail](https://github.com/mapvina/mapvina-native/blob/d92431b404b80b2e111c00a94eae51bbb45920fa/src/mbgl/style/layer_impl.hpp#L52)
    ...
    ///
    /// This type is optional since the default values in the C++ code base signifying that the
    /// property has not been explicitly set is an [implementation detail](https://github.com/mapvina/mapvina-native/blob/d92431b404b80b2e111c00a94eae51bbb45920fa/src/mbgl/style/layer_impl.hpp#L53)
    ///  that is not currently documented in the public API.
    ...
    /// style layer is able to be turned into a MapVina style layer and added to the view fairly quickly. This
...
public protocol SourceBoundVectorStyleLayerDefinition: SourceBoundStyleLayerDefinition {
    /**
     ...
     https://mapvina.com/mapvina-native/ios/api/predicates-and-expressions.html
     */
