...
public extension View {
    /// Customize the MapVina MapView's Controls.
    ///
    /// - Parameter buildControls: The map controls you want to include.
    @MainActor
    func mapControls(@MapControlsBuilder _ mapVinaMapControls: () -> [MapControl]) -> some View {
        modifier(MapControlsViewModifier(controls: mapVinaMapControls()))
    }
}
